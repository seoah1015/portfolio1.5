...
exports.preloadFonts = exports.preloadImages = exports.clamp = exports.map = void 0;

var imagesLoaded = require('imagesloaded'); // Clamps a value between an upper and lower bound
...
},{}],"yIBK":[function(require,module,exports) {
...
var splitting = (0, _splitting2.default)(); // initialize Locomotive Scroll
...
Promise.all([(0, _utils.preloadImages)(), (0, _utils.preloadFonts)('pcv4xiq')]).then(function () {
  // remove loader (loading class)
  document.body.classList.remove('loading'); // update locomotive scroll

  lscroll.update(); // keep track of the previous and current scroll values
  ...
  lscroll.on('scroll', function (obj) {
    ...
    var translateY = (0, _utils.map)(distance, 150, -150, -50, 50); // for every word from the splitting object...

    var _iterator = _createForOfIteratorHelper(splitting.entries()),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var charsTotal = word.chars.length; // for every char from each word...

        var _iterator2 = _createForOfIteratorHelper(word.chars.entries()),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            var factor = j < Math.ceil(charsTotal / 2) ? j : Math.ceil(charsTotal / 2) - Math.abs(Math.floor(charsTotal / 2) - j) - 1;
            char.style.transform = "translate3d(0,".concat(factor * translateY, "px,0)");
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
},{"./utils":"MgTz","locomotive-scroll":"ez7q","splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"yIBK","splitting":"Qdhu"}]},{},["QvaY"], null)
